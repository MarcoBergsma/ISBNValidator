...
public class ValidateISBN {
    ...
    public boolean checkISBN(String isbn) {
        if (isbn.length() == SHORT_ISBN_LENGTH) {
            ...
            return isThisAnValidLongDigitISBN(isbn);
        } else {
            throw new NumberFormatException("An ISBN with 10 or 13 digits is required");
        }
    }
    ...
    private boolean isThisAnValidLongDigitISBN(String isbn) {
        int total = 0;
